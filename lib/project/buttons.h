...
bool TL_STATUS = false;       // status of Touch Left  (true = pressed, false = released)
bool TR_STATUS = false;       // status of Touch Right (true = pressed, false = released)
...
int TL_COUNT = 0;             // to count number of times Touch Left is pressed within interval
int TR_COUNT = 0;             // to count number of times Touch Right is pressed within interval
...
int last_TL = 0;              // timer var to avoid function call trigger due contact bounce
int last_TR = 0;              // timer var to avoid function call trigger due contact bounce
