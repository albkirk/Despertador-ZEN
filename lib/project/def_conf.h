...
//#define ESP8266                                       // already defined elsewhere...
...
#define MODELName           "ZENDesperta"               // Hardware model name (TTGoTS = ZENDesperta, T5 = ZENDespertaE)
#define SWVer               "04.02"                     // Major.Minor Software version (use String 01.00 - 99.99 format !)
...
#define BUT_A               35                          // Button A INPUT pin (used in buttons.h) TTGoTS=35, T5=39
#define BUT_B               34                          // Button B INPUT pin (used in buttons.h) TTGoTS=34,
#define BUT_C               39                          // Button C INPUT pin (used in buttons.h) TTGoTS=39,
#define T_Left              T7                          // Touch button Left  pin. TTGoTS=T7, T5=-1, -1 means NOT used!
...
#define Default_ADC_PIN     36                          // IO pin forBattery ADC measurement. TFT = 36, EPaper = 35

// -- SPI PIN Definition --
#define MISO_PIN            -1                          // SPI MISO pin, Display TTGoTS->-1, T5->-1, -1 means NOT used!
#define MOSI_PIN            23                          // SPI MOSI pin, Display TTGoTS->23, T5->23, -1 means NOT used!
#define CLK_PIN              5                          // SPI CLK pin, Display TTGoTS-> 5, T5->18, -1 means NOT used!
#define CS_PIN              16                          // SPI CS pin, Display  TTGoTS->16, t5->5 -1 means NOT used!
...
#define RST_PIN             16                          // Display RST pin,   TTGoTS-> 9, T5->16, -1 means NOT used!
#define DC_PIN              17                          // Display DC pin,    TTGoTS->17, T5->17, -1 means NOT used!
